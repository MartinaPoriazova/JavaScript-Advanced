...
function solve() {
  ...
  function createPost(e) {
    ...
    function createDOMElements(titleValue, categoryValue, contentValue) {
      ...
      let approvenBtn = document.createElement("button");
      approvenBtn.classList.add("action-btn");
      approvenBtn.classList.add("approve");
      approvenBtn.textContent = "Approve";
      approvenBtn.addEventListener("click", approvePost());

      li.appendChild(article);
      li.appendChild(editButton);
      li.appendChild(approvenBtn);
